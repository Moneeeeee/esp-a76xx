...
#define AT_EVENT_COMMAND_PROMPT BIT5
...
public:
    ...
    ~Ml307AtModem();
    bool CommandWaitPrompt(const std::string& command, char prompt_char, int timeout_ms) ;
...
private:
    ...
    int pin_ready_ = 0;
    bool ip_ready_ = false;
    bool pdn_ready_ = false;
    int cereg_state_ = 0;
